...
export type ExportAuditLogsRequest = Message<"blueapi.admin.v1.ExportAuditLogsRequest"> & {
   ...
   *
   * @generated from field: string waveUserId = 5;
   */
  waveUserId: string;
};
