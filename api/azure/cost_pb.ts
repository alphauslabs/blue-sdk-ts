 ...
 */
export const file_api_azure_cost: GenFile = /*@__PURE__*/
  fileDesc("");

/**
 * @generated from message blueapi.api.azure.Cost
 */
export type Cost = Message<"blueapi.api.azure.Cost"> & {
  /**
   ...
   *
   * @generated from field: string resourceGroup = 26;
   */
...
export const CostSchema: GenMessage<Cost> = /*@__PURE__*/
  messageDesc(file_api_azure_cost, 0);

/**
 * @generated from message blueapi.api.azure.CostAttribute
 */
export type CostAttribute = Message<"blueapi.api.azure.CostAttribute"> & {
  /**
...
export const CostAttributeSchema: GenMessage<CostAttribute> = /*@__PURE__*/
  messageDesc(file_api_azure_cost, 1);
