 ...
 */
export const file_api_cover_asset: GenFile = /*@__PURE__*/
  fileDesc("");

/**
 * @generated from message blueapi.api.cover.Asset
 */
export type Asset = Message<"blueapi.api.cover.Asset"> & {
  /**
...
export const AssetSchema: GenMessage<Asset> = /*@__PURE__*/
  messageDesc(file_api_cover_asset, 0);

/**
 * @generated from message blueapi.api.cover.EC2Instance
 */
export type EC2Instance = Message<"blueapi.api.cover.EC2Instance"> & {
  /**
 ...
 */
export const EC2InstanceSchema: GenMessage<EC2Instance> = /*@__PURE__*/
  messageDesc(file_api_cover_asset, 1);

/**
 * @generated from message blueapi.api.cover.Tag
 */
export type Tag = Message<"blueapi.api.cover.Tag"> & {
  /**
   * @generated from field: string key = 1;
   */
  key: string;
...
export const TagSchema: GenMessage<Tag> = /*@__PURE__*/
  messageDesc(file_api_cover_asset, 2);
