 ...
 */
export declare const file_api_cover_costforecast: GenFile;

/**
 * @generated from message blueapi.api.cover.AwsCostForecast
 */
export declare type AwsCostForecast = Message<"blueapi.api.cover.AwsCostForecast"> & {
  /**
 ...
 */
export declare const AwsCostForecastSchema: GenMessage<AwsCostForecast>;
