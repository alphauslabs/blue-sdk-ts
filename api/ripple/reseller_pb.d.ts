 ...
 */
export declare const file_api_ripple_reseller: GenFile;

/**
 * @generated from message blueapi.api.ripple.Reseller
 */
export declare type Reseller = Message<"blueapi.api.ripple.Reseller"> & {
  /**
 ...
 */
export declare const ResellerSchema: GenMessage<Reseller>;

/**
 * @generated from message blueapi.api.ripple.ResellerConfig
 */
export declare type ResellerConfig = Message<"blueapi.api.ripple.ResellerConfig"> & {
  /**
   * key
   *
   * For Wave
 ...
 */
export declare const ResellerConfigSchema: GenMessage<ResellerConfig>;
