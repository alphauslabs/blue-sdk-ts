 ...
 *
 * @generated from message blueapi.iam.v1.ExperimentalUIPreference
 */
export type ExperimentalUIPreference = Message<"blueapi.iam.v1.ExperimentalUIPreference"> & {
  /**
   ...
   *
   * @generated from field: bool banner_dismissed = 3;
   */
 ...
 */
export const ExperimentalUIPreferenceSchema: GenMessage<ExperimentalUIPreference> = /*@__PURE__*/
 ...
 *
 * @generated from message blueapi.iam.v1.GetExperimentalUIPreferencesRequest
 */
export type GetExperimentalUIPreferencesRequest = Message<"blueapi.iam.v1.GetExperimentalUIPreferencesRequest"> & {
};
 ...
 */
export const GetExperimentalUIPreferencesRequestSchema: GenMessage<GetExperimentalUIPreferencesRequest> = /*@__PURE__*/
  messageDesc(file_iam_v1_iam, 51);

/**
 * Response message for the Iam.GetExperimentalUIPreferences rpc.
 *
 * @generated from message blueapi.iam.v1.GetExperimentalUIPreferencesResponse
 */
export type GetExperimentalUIPreferencesResponse = Message<"blueapi.iam.v1.GetExperimentalUIPreferencesResponse"> & {
  /**
   * The list of experimental UI preferences for the authenticated MSP.
   *
   * @generated from field: repeated blueapi.iam.v1.ExperimentalUIPreference preferences = 1;
   */
  preferences: ExperimentalUIPreference[];
};
 ...
 */
export const GetExperimentalUIPreferencesResponseSchema: GenMessage<GetExperimentalUIPreferencesResponse> = /*@__PURE__*/
  messageDesc(file_iam_v1_iam, 52);

/**
 * Request message for the Iam.UpsertExperimentalUIPreference rpc.
 *
 * @generated from message blueapi.iam.v1.UpsertExperimentalUIPreferenceRequest
 */
export type UpsertExperimentalUIPreferenceRequest = Message<"blueapi.iam.v1.UpsertExperimentalUIPreferenceRequest"> & {
  /**
 ...
 */
export const UpsertExperimentalUIPreferenceRequestSchema: GenMessage<UpsertExperimentalUIPreferenceRequest> = /*@__PURE__*/
  messageDesc(file_iam_v1_iam, 53);

/**
 * Response message for the Iam.UpsertExperimentalUIPreference rpc.
 *
 * @generated from message blueapi.iam.v1.UpsertExperimentalUIPreferenceResponse
 */
export type UpsertExperimentalUIPreferenceResponse = Message<"blueapi.iam.v1.UpsertExperimentalUIPreferenceResponse"> & {
  /**
   * The created or updated preference.
   *
   * @generated from field: blueapi.iam.v1.ExperimentalUIPreference preference = 1;
   */
  preference?: ExperimentalUIPreference;
};
 ...
 */
export const UpsertExperimentalUIPreferenceResponseSchema: GenMessage<UpsertExperimentalUIPreferenceResponse> = /*@__PURE__*/
  messageDesc(file_iam_v1_iam, 54);
...
export type UnlockUserAccountRequest = Message<"blueapi.iam.v1.UnlockUserAccountRequest"> & {
   ...
   *
   * @generated from field: bool reset_password = 5;
   */
...
export const UnlockUserAccountRequestSchema: GenMessage<UnlockUserAccountRequest> = /*@__PURE__*/
  messageDesc(file_iam_v1_iam, 55);
...
export const Iam: GenService<{
   ...
   *
   * @generated from rpc blueapi.iam.v1.Iam.GetExperimentalUIPreferences
   */
  getExperimentalUIPreferences: {
    methodKind: "unary";
    input: typeof GetExperimentalUIPreferencesRequestSchema;
    output: typeof GetExperimentalUIPreferencesResponseSchema;
  },
  /**
   * Creates or updates an experimental UI preference for a specific component.
   *
   * @generated from rpc blueapi.iam.v1.Iam.UpsertExperimentalUIPreference
   */
  upsertExperimentalUIPreference: {
    methodKind: "unary";
    input: typeof UpsertExperimentalUIPreferenceRequestSchema;
    output: typeof UpsertExperimentalUIPreferenceResponseSchema;
  },
  /**
